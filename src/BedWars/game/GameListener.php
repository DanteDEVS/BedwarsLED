	...
	public function onInteract(PlayerInteractEvent $event): void
	{
		...
		if ($item->getId() == Item::WOOL) {
			...
			if ($playerGame->getState() == Game::STATE_RUNNING) {
				...
				unset($player, $this->plugin->);
			}
		}
	}
