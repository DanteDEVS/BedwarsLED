...
class BedWarsCommand extends Command implements PluginIdentifiableCommand {
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args) {
        if(!isset($args[0])) {
            $sender->sendMessage("§cUsage: §7/bw1 help");
            return;
        }
        switch ($args[0]) {
             case "help":
                ...
                $sender->sendMessage("§a> BedWars commands:\n" .
                    "§7/bw1 help : Displays list of BedWars commands\n".
                    "§7/bw1 create : Create BedWars arena\n".
                    "§7/bw1 remove : Remove BedWars arena\n".
                    "§7/bw1 set : Set BedWars arena\n".
                    "§7/bw1 random : Join random arena BedWars\n".
                    "§7/bw1 test : Test BedWars\n".
                    "§7/bw1 stoptest : Stop test BedWars\n".
                    "§7/bw1 arenas : Displays list of arenas");
                break;
            case "create":
                ...
                if(!isset($args[1])) {
                    $sender->sendMessage("§cUsage: §7/bw1 create <arenaName>");
                    break;1
                }
            ...
            case "remove":
                ...
                if(!isset($args[1])) {
                    $sender->sendMessage("§cUsage: §7/bw1 remove <arenaName>");
                    break;
                }
                if(!isset($this->plugin->arenas[$args[1]])) {
            ...
            case "set":
                ...
                if(!isset($args[1])) {
                    $sender->sendMessage("§cUsage: §7/bw1 set <arenaName>");
                    break;
                }
            ...
            case "test":
                ...
                break;
            case "stoptest":
                if(!$sender->hasPermission("bw.cmd.stoptest")) {
                    $sender->sendMessage("§cYou have not permissions to use this command!");
                    break;
                }
                if(!$sender instanceof Player) {
